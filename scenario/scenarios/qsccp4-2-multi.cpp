...
namespace ns3
{
    ...
    main(int argc, char *argv[])
    {
        ...
        ndn::L3RateTracer::InstallAll("qsccp4-2-mircc-no-pit-merge-throughput.txt", Seconds(0.1));
        ndn::AppDelayTracer::InstallAll("qsccp4-2-mircc-no-pit-merge-delay.txt");
        L2RateTracer::InstallAll("qsccp4-2-mircc-no-pit-merge-drop.txt", Seconds(0.1));
        Simulator::Run();
        Simulator::Destroy();
