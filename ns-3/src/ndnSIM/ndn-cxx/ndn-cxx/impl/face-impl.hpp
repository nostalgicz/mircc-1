...
public: // consumer
                       ...
                       const TimeoutCallback& afterTimeout)
  {
    ...
    //add by ljq
    addFieldFromTag<lp::PTagField, lp::PTag>(lpPacket, interest2);
    addFieldFromTag<lp::PathidTagField, lp::PathidTag>(lpPacket, interest2);
    addFieldFromTag<lp::RpTagField, lp::RpTag>(lpPacket, interest2);
    addFieldFromTag<lp::RsTagField, lp::RsTag>(lpPacket, interest2);
    //
...
public: // producer
  ...
  asyncPutData(const Data& data)
  {
    ...
    //add by ljq
    addFieldFromTag<lp::PTagField, lp::PTag>(lpPacket, data);
    addFieldFromTag<lp::RpTagField, lp::RpTag>(lpPacket, data);
    addFieldFromTag<lp::RsTagField, lp::RsTag>(lpPacket, data);
    addFieldFromTag<lp::PathidTagField, lp::PathidTag>(lpPacket, data);
    //
