...
typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::PTag> PTagField;
BOOST_CONCEPT_ASSERT((Field<PTagField>));

typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::PathidTag> PathidTagField;
BOOST_CONCEPT_ASSERT((Field<PathidTagField>));

typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::RpTag> RpTagField;
BOOST_CONCEPT_ASSERT((Field<RpTagField>));

typedef FieldDecl<field_location_tags::Header,
                  uint64_t,
                  tlv::RsTag> RsTagField;
BOOST_CONCEPT_ASSERT((Field<RsTagField>));
//
