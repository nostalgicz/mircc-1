...
extractLpLocalFields(NetPkt& netPacket, const lp::Packet& lpPacket)
{
  ...
  //add by ljq
  addTagFromField<lp::PTag, lp::PTagField>(netPacket, lpPacket);
  addTagFromField<lp::PathidTag, lp::PathidTagField>(netPacket, lpPacket);
  addTagFromField<lp::RpTag, lp::RpTagField>(netPacket, lpPacket);
  addTagFromField<lp::RsTag, lp::RsTagField>(netPacket, lpPacket);
  //
}
